...
<table cellspacing="0" class="cart <?php echo $args['list_class']; ?>">
	<tbody>
        ...
        <tr>
			<td class="actions" colspan="6">
				...
				<div class="actions-continue">
					...
					<input onclick="javascript:window.location='<?php echo WC()->cart->get_checkout_url(); ?>'" type="submit" value="<?php _e( 'Checkout &raquo;', 'spyropress' ); ?>" name="proceed" class="btn pull-right btn-primary checkout">
				</div>
