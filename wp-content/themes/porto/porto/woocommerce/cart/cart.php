                			...
                			if ( $_product && $_product->exists() && $cart_item['quantity'] > 0 && apply_filters( 'woocommerce_cart_item_visible', true, $cart_item, $cart_item_key ) ) {
                				...
                				<tr class="cart_table_item <?php echo esc_attr( apply_filters( 'woocommerce_cart_item_class', 'cart_item', $cart_item, $cart_item_key ) ); ?>">
                					...
                					<td class="product-remove">
                						<?php
                							echo apply_filters( 'woocommerce_cart_item_remove_link', sprintf( '<a href="%s" class="remove" title="%s"><i class="icon icon-times"></i></a>', esc_url( WC()->cart->get_remove_url( $cart_item_key ) ), __( 'Remove this item', 'woocommerce' ) ), $cart_item_key );
                						?>
                					</td>
	...
	<div class="col-md-12">
		<div class="actions-continue">
            <form action="<?php echo esc_url( WC()->cart->get_checkout_url() ); ?>" method="post">
                <input type="submit" class="checkout-button btn btn-lg btn-primary alt wc-forward" name="proceed" value="<?php _e( 'Proceed to Checkout &raquo;', 'woocommerce' ); ?>" />
            </form>
		</div>
	</div>
</div>
